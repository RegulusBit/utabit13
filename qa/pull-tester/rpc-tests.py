...
if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/utabit/utabit/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/utabit/utabit/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_UTABITD == 1):
...
class RPCTestHandler:
    ...
    def __init__(self, num_tests_parallel, test_list=None, flags=None):
        ...
        self.flags = flags
        self.num_running = 0
        # In case there is a graveyard of zombie utabitds, we can apply a
