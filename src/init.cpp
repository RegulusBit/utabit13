 ...
 * between utabitd, and utabit-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), UTABIT_CONF_FILENAME));
    if (mode == HMM_UTABITD)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), UTABIT_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/utabit/utabit13>";
    const std::string URL_WEBSITE = "<https://utabitcore.org>";
...
/** Sanity checks
 *  Ensure that Utabit is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Utabit process is using the data directory.
