...
#include "config/utabit-config.h"
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBUTABITCONSENSUS)
...
EXPORT_SYMBOL unsigned int utabitconsensus_version();
...
#endif // UTABIT_UTABITCONSENSUS_H
