...
#define BOOST_TEST_MODULE Utabit Test Suite

#include "test_utabit.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_utabit_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
