 ...
 */
#ifndef UTABIT_UTIL_H
#define UTABIT_UTIL_H
...
extern const char * const UTABIT_CONF_FILENAME;
extern const char * const UTABIT_PID_FILENAME;
...
{
    std::string s = strprintf("utabit-%s", name);
