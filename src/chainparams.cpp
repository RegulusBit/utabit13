...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 26250;
        ...
        genesis = CreateGenesisBlock(1498902526, 1125628613, 0x1d00ffff, 1, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000412d0f82e4127af4fdab3645d3aea29b39f53ee799c8f47248db07b2"));
...
/*      vSeeds.push_back(CDNSSeedData("185.10.73.72", "185.10.73.72", true));
        ...
        vSeeds.push_back(CDNSSeedData("utabit.jonasschnelli.ch", "seed.utabit.jonasschnelli.ch", true)); // Jonas Schnelli, only supports x1, x5, x9, and xd
*/
...
public:
    CTestNetParams() {
       ...
       // assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        vSeeds.push_back(CDNSSeedData("testnetutabit.jonasschnelli.ch", "testnet-seed.utabit.jonasschnelli.ch", true));
        vSeeds.push_back(CDNSSeedData("petertodd.org", "seed.tubit.petertodd.org", true));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("utabit.schildbach.de", "testnet-seed.utabit.schildbach.de"));
